...
export const trustV5PipelineSchema = z.object({
  ...
  finalDecision: z.object({
    ...
    truthStatus: z.string(),
    enforcement: z.string(),
    presentedTruthStatus: z.string(),
    presentedEnforcement: z.string(),
    l4Decision: z.object({ security: z.string().optional(), truth: z.string().optional(), action: z.string().optional() }).passthrough().optional(),
    assuranceStatus: z.string().optional(),
    assuranceApplied: z.boolean().optional(),
    decisionAuthority: z.string(),
    assuranceAuthority: z.string().nullable().optional(),
    isHardNegative: z.boolean().optional(),
