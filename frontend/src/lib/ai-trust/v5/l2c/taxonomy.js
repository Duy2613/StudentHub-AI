...
export const STUDENT_DOMAIN_TAXONOMY = Object.freeze([
  ...
  { id: "AUTHORITY_PAYMENT_SCAM", highRisk: true, description: "Mạo danh công an, ngân hàng hoặc nhà trường để ép chuyển tiền." },
  { id: "EMERGENCY_TRANSFER_SCAM", highRisk: true, description: "Dùng tai nạn/sự cố khẩn cấp để thúc ép chuyển tiền." },
  { id: "GUARANTEED_INVESTMENT_SCAM", highRisk: true, description: "Cam kết lợi nhuận phi thực tế hoặc không có rủi ro." },
  { id: "LOAN_ADVANCE_FEE", highRisk: true, description: "Yêu cầu phí trước khi giải ngân hoặc mở khóa khoản vay." },
  { id: "FAKE_ESCROW", highRisk: true, description: "Giả mạo ký quỹ/sàn thương mại để thu phí nâng cấp tài khoản." },
  { id: "ACCOUNT_VERIFICATION_SCAM", highRisk: true, description: "Yêu cầu chuyển tiền để xác minh hoặc hoàn lại tiền." },
  { id: "PERSONAL_TRANSFER_IMPERSONATION", highRisk: true, description: "Mạo danh người quen để thúc ép chuyển tiền vào tài khoản chưa xác minh." },
