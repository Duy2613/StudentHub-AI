...
const makeAsset = ({ id, stem, routeRole, sourceSha256, priority = false, decorative = true, embeddedTextRisk = "LOW", humanIllustrative = false, provenance }) => Object.freeze({
  id,
  routeRole,
  desktopSrc: `${ROOT}/${stem}-desktop.webp`,
  tabletSrc: `${ROOT}/${stem}-tablet.webp`,
  mobileSrc: `${ROOT}/${stem}-mobile.webp`,
  ogSrc: `${ROOT}/${stem}-og.webp`,
  decorativeSrc: `${ROOT}/${stem}-mobile.webp`,
  width: 1600,
  height: 900,
