import pg from "pg";
import { assertLocalDatabaseTarget } from "../../security/environment/stagingEnvironment.js";
...
export function getPostgresPool() {
  ...
  if (process.env.NODE_ENV !== "production" || process.env.STUDENTHUB_TEST_RUNNER === "1") {
    assertLocalDatabaseTarget(process.env);
  }
