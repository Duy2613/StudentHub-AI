...
export default function CollapsibleSidebar({ className = "" }) {
  ...
  const navItems = [
    ...
    {
      label: "Sàn Pass Đồ & Sách",
      href: "/marketplace",
      icon: ShoppingBag,
      badge: "Bảo Chứng",
      badgeColor: "bg-[#ffd15c]/20 text-[#ffd15c] border-[#ffd15c]/40",
    },
    {
      label: "Đấu Trường Hiệp Sĩ",
      href: "/quests",
      icon: Trophy,
      badge: "Nhiệm Vụ",
