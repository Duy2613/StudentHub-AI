  ...
  try {
    ...
    return NextResponse.json({
      ...
      user: {
        ...
        institutionalEmailVerified: attributes.institutionalEmailVerified === true,
        verificationSource: attributes.verificationSource || "NONE",
        qaEntitlements: Array.isArray(attributes.qaEntitlements) ? attributes.qaEntitlements : [],
        qaStudentFeatureAccess: attributes.qaStudentFeatureAccess === true,
        demoFeatureAccess: attributes.demoFeatureAccess === true,
        demoAccessSource: attributes.demoAccessSource || null,
