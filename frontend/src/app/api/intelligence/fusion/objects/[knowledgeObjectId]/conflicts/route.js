...
export const GET = SecurityFabric.wrapHandler({
  action: "READ_KNOWLEDGE_CONFLICTS",
  allowAnonymous: true,
  maxRequests: 90
  ...
  return Response.json({
    success: true,
    knowledgeObjectId,
    contradictions: kno.contradictions || [],
    realityGaps: kno.realityGaps || [],
    sourceState: "CURATED_REFERENCE_FIXTURE",
    isAuthoritative: false,
    dataNotice: "Xung đột và khoảng trống là tín hiệu phân tích, không phải phán quyết chính thức."
  });
});
