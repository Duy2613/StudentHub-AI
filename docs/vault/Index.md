...
```mermaid
graph TD
    Index["🌌 Index (Central Hub)"] --> Meta["🧠 00 - AI Agent Permanent Context"]
    Index --> Arch["🏗️ 01 - System Architecture"]
    ...
    Arch --> SysArch["System-Architecture.md"]
    ...
    Design --> OpenHero["OpenHero-Cinematic-Aesthetics.md"]

    Features --> Mentor["AI-Mentor-Copilot.md"]
...
- [[Community-Intelligence-V1|👥 Community & Forum Intelligence V1 (Phase T3)]]: Real-World Experience Graph → Consensus Engine → Procedure Duration Mining → Astroturfing Defense.
